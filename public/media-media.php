...
$albums_container = '<div class="galleries-container col-md-10 col-xs-12">
            ...
            <div class="grid">
                <figure class="effect-oscar">
                    ...
                    <figcaption>
                        <h2>'.$media_title.'</h2>
                        '.$media_desc.'
                        <a class=" cover-photo-gallery" href="'.$media_link.'" target="_blank" title="'.$media_title.'"></a>
                    </figcaption>
                </figure>
...
<div class="row gallery-row-container">
    ...
    <div class="col-md-11 col-xs-10">
        <h1 class="text-center gallery-title"> MEDIA </h1>
    </div>
</div>
<?=$albums_container?>