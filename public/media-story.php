    ...
    if ($dh = opendir($full_dir)) {
        ...
        while (($file = readdir($dh)) !== false) {
            if (!is_dir($full_dir.$file)) {
                 ...
                 $album_photos .= '<a class="fancybox photo-gallery-hide" href="'.$dir_from_index.$album_folder . '/' .$file.'" data-fancybox-group="gallery'.$i.'" title="'.$img_desc.'"></a>';
            ...
            <div class="grid col-xs-12">
                <figure class="effect-oscar">
                    ...
                    <figcaption>
                        ...
                        <a class="fancybox cover-photo-gallery" href="includes/uploads/p-cover/'.$story_cover.'" data-fancybox-group="gallery'.$i.'" title="'.$story_desc.'"></a>
                    </figcaption>
                </figure>
...
<div class="row gallery-row-container">
    ...
    <div class="col-md-11 col-xs-10">
        <h1 class="text-center gallery-title"> STORIES </h1>
    </div>
</div>
<?=$albums_container?>